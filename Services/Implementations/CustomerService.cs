...
namespace AdoProject.Services.Implementations
{
    ...
    public class CustomerService : ICustomerService
    {
        ...
        public static ICustomerRepository _customerRepository = new CustomerRepository();
        public static IWalletRepository _walletRepository = new WalletRepository();


        public Customer Create(string name, string email, string password, string phoneNumber, int gend, int pin)
        {
